...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TOGOLIVING — Villa Balnéaire Tropicale à Lomé, Togo" },
      { property: "og:description", content: "Résidence balnéaire de luxe à Kpogan Agbetsiko, Lomé. Appartements vue mer, piscine panoramique, restaurant et cocktail bar." },
      ...
      { name: "twitter:title", content: "TOGOLIVING — Villa Balnéaire Tropicale à Lomé, Togo" },
      { name: "twitter:description", content: "Résidence balnéaire de luxe à Kpogan Agbetsiko, Lomé. Appartements vue mer, piscine panoramique, restaurant et cocktail bar." },
      { name: "twitter:image", content: "https://residencetogoliving.com/og-image.jpg" },
    ],
    links: [
