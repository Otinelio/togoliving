...
import { W as Wifi, j as Wind, T as Tv, e as Coffee, k as WavesHorizontal, U as UtensilsCrossed, l as BedDouble, i as MessageCircle, m as Car, n as Plane, D as Droplets, c as GlassWater } from "../_libs/lucide-react.mjs";
...
function Page() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative pt-32 pb-20 bg-ocean text-white overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[url('https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-40" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-sand py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 space-y-20", children: rooms.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: r.img, alt: r.title, loading: "lazy", className: "w-full h-[420px] object-cover rounded-2xl shadow-xl shadow-ocean/20" }),
