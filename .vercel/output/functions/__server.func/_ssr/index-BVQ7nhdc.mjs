...
import { p as poolImg } from "./accueil2_img-CMh7MIIh.mjs";
...
import { A as ArrowRight, p as WavesHorizontal, q as BedDouble, D as Droplets, U as UtensilsCrossed, F as Star, b as MapPin, K as Calendar, N as Users } from "../_libs/lucide-react.mjs";
...
const heroImg = "/assets/accueil_img-CATZu7_5.jpg";
const rooms = [{
  id: "studio",
  title: "Studio",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative py-24 text-white", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-6xl mx-auto px-6 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-4 gap-5 mt-10", children: [{
          ...
          delay: i * 0.1
        }, className: "glass-dark p-8 hover:border-gold transition text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(UtensilsCrossed, { className: "mx-auto text-turquoise mb-3", size: 22 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-lg", children: c.label })
        ] }, c.label)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-sand py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-accent text-turquoise text-xl", children: "Ils nous ont visités" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl text-ocean", children: "Avis Voyageurs" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-center gap-6 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass px-6 py-3 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[#003580] font-bold text-lg", children: "booking" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-ocean font-display text-2xl font-bold", children: [
            "7,2",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body text-muted-foreground", children: "/10" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "14 avis" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass px-6 py-3 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5", children: [0, 1, 2, 3, 4].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 13, className: s < 4 ? "text-gold fill-current" : "text-gold/40" }, s)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-ocean font-display text-2xl font-bold", children: [
            "4,3",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-body text-muted-foreground", children: "/5" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: [{
        ...
        delay: i * 0.1
      }, className: "glass p-6 hover-lift flex flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [0, 1, 2, 3, 4].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 14, className: s < r.stars ? "text-gold fill-current" : "text-gold/30" }, s)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-semibold px-2 py-0.5 rounded-full ${r.src === "booking" ? "bg-[#003580]/10 text-[#003580]" : "bg-[#4285F4]/10 text-[#4285F4]"}`, children: r.label })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-accent text-base text-ocean leading-relaxed flex-1", children: [
          '"',
          r.q,
          '"'
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-4 font-medium", children: [
          "— ",
          r.a
        ] })
      ] }, i)) })
