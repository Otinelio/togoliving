...
const appCss = "/assets/styles-DYWjpHi5.css";
...
function Logo({ className = "", size = "text-2xl" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-ocean", children: "TOGO" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display text-3xl md:text-4xl font-bold tracking-wide", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white", children: "TOGO" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-turquoise", children: "LIVING" })
        ] }),
...
const $$splitComponentImporter$a = () => import("./restaurant-BCJyImcN.mjs");
const Route$a = createFileRoute("/restaurant")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Saveurs du monde : cuisine africaine, francaise, americaine, cocktails signature. Restaurant vue mer a Lome."
    }, {
      property: "og:title",
...
const $$splitComponentImporter$9 = () => import("./reserver-BWZksR77.mjs");
...
const $$splitComponentImporter$8 = () => import("./reception-BDTImuwG.mjs");
const Route$8 = createFileRoute("/reception")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./kitchen-CG3nDLCc.mjs");
const Route$7 = createFileRoute("/kitchen")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./hebergements-bGMBVN5t.mjs");
...
const $$splitComponentImporter$5 = () => import("./galerie-Npc6UnuP.mjs");
...
const $$splitComponentImporter$4 = () => import("./contact-BWMG3dQU.mjs");
...
const $$splitComponentImporter$3 = () => import("./admin-CDRH9J5L.mjs");
const Route$3 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./a-propos-DjnygyeM.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-404nU0W1.mjs");
...
const $$splitComponentImporter = () => import("./room._roomId-CyvH3P8r.mjs");
